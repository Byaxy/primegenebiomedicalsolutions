...
const ImagingSolutionsSection = () => {
  return (
    <section className="relative w-full py-24 bg-waves bg-repeat">
      <div className="absolute top-0 left-0 w-full h-full bg-grayColor/95 z-10" />
      <div className="wraper lg:flex lg:gap-4">
        <div className="px-2 z-30 relative">
          <header className="font-body py-4 text-center">
            ...
            <p className="text-gray-500 py-2 lg:text-left">
              Technique used in radiology to form pictures of the anatomy and
              the physiological processes of the body in both health and disease
            </p>
          </header>
