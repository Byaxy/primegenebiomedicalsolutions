              ...
              {open === index ? (
                <>
                  {item.sections ? (
                    <div
                      className={`${
                        open === 3 ? "right-[18%]" : "right-0"
                      } absolute top-[4.5rem]  max-w-[100%] bg-sectionBg bg-cover rounded-xl overflow-hidden z-[90] text-darkerBlue font-semibold transition-all ease-in-out duration-700 scale-up-center`}
                    >
