...
const SterileReadyPreparedPlates = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[1]?.sections[0]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[3]?.sections[1]?.sections[0]?.path;
  return (
...
export default SterileReadyPreparedPlates;
