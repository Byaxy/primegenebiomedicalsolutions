...
const SterileDisinfectants = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[5]?.products;
  const path = navBarData[2]?.sections[0]?.sections[3]?.sections[5]?.path;
...
export default SterileDisinfectants;
