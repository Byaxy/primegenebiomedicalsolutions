...
const AntimicrobialResistanceManagement = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[2]?.sections[0]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[3]?.sections[2]?.sections[0]?.path;
...
export default AntimicrobialResistanceManagement;
