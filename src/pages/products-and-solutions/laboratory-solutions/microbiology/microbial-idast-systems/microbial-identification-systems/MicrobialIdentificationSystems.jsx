...
const MicrobialIdentificationSystems = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[2]?.sections[1]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[3]?.sections[2]?.sections[1]?.path;
...
export default MicrobialIdentificationSystems;
