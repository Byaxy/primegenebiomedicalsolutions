...
const QualityControlOrganisms = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[7]?.products;
  const path = navBarData[2]?.sections[0]?.sections[3]?.sections[7]?.path;
...
export default QualityControlOrganisms;
