...
const InhibitionZoneReaders = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[3]?.sections[0]?.sections[6]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[3]?.sections[0]?.sections[6]?.path;
...
export default InhibitionZoneReaders;
