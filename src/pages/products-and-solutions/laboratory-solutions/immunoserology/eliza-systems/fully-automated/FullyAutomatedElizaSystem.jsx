...
const FullyAutomatedElizaSystem = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[2]?.sections[1]?.sections[0]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[2]?.sections[1]?.sections[0]?.path;
...
export default FullyAutomatedElizaSystem;
