...
const CliaReagentsSystems = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[2]?.sections[0]?.sections[3]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[2]?.sections[0]?.sections[3]?.path;
...
export default CliaReagentsSystems;
