...
const FullyAutomatedCliaSystem = () => {
  const products =
    navBarData[2]?.sections[0]?.sections[2]?.sections[0]?.sections[2]?.products;
  const path =
    navBarData[2]?.sections[0]?.sections[2]?.sections[0]?.sections[2]?.path;
  return (
...
export default FullyAutomatedCliaSystem;
